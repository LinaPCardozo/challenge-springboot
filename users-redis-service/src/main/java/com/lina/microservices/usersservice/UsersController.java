...
import com.lina.microservices.usersservice.repository.UsersRepository;
...
public class UsersController {
	...
	public ResponseEntity<Object> retrieveUser(@PathVariable int id) throws Exception {
		...
		if (!user.isPresent())
			return new ResponseEntity<Object>("The user with id " + id + " does not exist.", HttpStatus.NOT_FOUND);
